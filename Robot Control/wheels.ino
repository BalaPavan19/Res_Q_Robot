...
std::vector<MOTOR_PINS> motorPins = 
{
  ...
  {2, 4, 5},   // RIGHT_MOTOR2 Pins (EnC, IN5, IN6)
  {2, 6, 7},   // LEFT_MOTOR2  Pins (EnD, IN7, IN8)
...
void moveCar(int inputValue)
{
  ...
  switch(inputValue)
  {
    ...
    case UP:
      ...
      rotateMotor(RIGHT_MOTOR2, FORWARD);
      rotateMotor(LEFT_MOTOR2, FORWARD);                  
      break;
  
    case DOWN:
      rotateMotor(RIGHT_MOTOR, BACKWARD);
      rotateMotor(LEFT_MOTOR, BACKWARD);
      rotateMotor(RIGHT_MOTOR2, BACKWARD);
      rotateMotor(LEFT_MOTOR2, BACKWARD);  
      break;
  
    case LEFT:
      rotateMotor(RIGHT_MOTOR1, FORWARD);
      rotateMotor(LEFT_MOTOR1, BACKWARD);  
      rotateMotor(RIGHT_MOTOR2, FORWARD);
      rotateMotor(LEFT_MOTOR2, BACKWARD);
      break;
  
    case RIGHT:
      rotateMotor(RIGHT_MOTOR1, BACKWARD);
      rotateMotor(LEFT_MOTOR1, FORWARD); 
      rotateMotor(RIGHT_MOTOR2, BACKWARD);
      rotateMotor(LEFT_MOTOR2, FORWARD);
      break;
 
    case STOP:
      rotateMotor(RIGHT_MOTOR1, STOP);
      rotateMotor(LEFT_MOTOR1, STOP);
      rotateMotor(RIGHT_MOTOR2, STOP);
      rotateMotor(LEFT_MOTOR2, STOP);
      break;
